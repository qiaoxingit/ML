...
def run_mimic_popsize_optimal():
    ...
    mimic_popsize_optimal(problem=problem, pop_sizes=np.arange(100, 1500, 150), random_seeds=random_seeds, label = "flip_flop mimic pop size", title = "flip_flop mimic pop size optimization")
...
def run_run_problems():
    ...
    run_problems(problem=problem, rhc_max_attempts=1000, decay_rate=0.3, sa_max_attempts=1000, ga_max_attempts=500, GA_popSize=1200, GA_pop_breed_pec=0.2, mimic_max_attempts=50, mimic_popSize=1300, mimic_keepPct=0.5, title = "Flip Flop")
