...
def run_flip_flop():
    ...
    GA_pop_breed_pec_optimal(problem=problem, pop_breed_pecs=np.arange(0, 1, 0.05), random_seeds=random_seeds, label = "flip_flop GA pop breed pec", title = "flip_flop GA pop breed pec optimization")
