...
def run_four_peaks():
    ...
    GA_mutationProb_optimal(problem=problem, mutation_probs=np.arange(0, 1, 0.05), random_seeds=random_seeds, label = "Four Peaks GA mutation prob", title = "Four Peaks GA mutation prob optimization")
    ...
    run_problems(problem=problem, rhc_max_attempts=8000, decay_rate=0.02, sa_max_attempts=8000, ga_max_attempts=300, GA_popSize=1000, GA_mutationProb=0.1, mimic_max_attempts=300, mimic_popSize=1000, mimic_keepPct=0.2, random_seeds=random_seeds, title = "Four Peaks")
