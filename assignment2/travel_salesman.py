...
def run_task6():
    ...
    run_problems(problem=problem, rhc_max_attempts=800, decay_rate=0.02, sa_max_attempts=800, ga_max_attempts=100, GA_popSize=100, GA_pop_breed_pec=0.1, mimic_max_attempts=30, mimic_popSize=700, mimic_keepPct=0.2, random_seeds=random_seeds, title = "Travel Salesmen")
